...
if (!MC_API_KEY) {
  console.error('Error: MC_API_KEY not found');
  console.error('Loaded from .env.local:', Object.keys(envLocal));
  console.error('Expected: MC_API_KEY and MC_URL in .env.local or environment');
  process.exit(1);
}
